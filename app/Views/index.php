...
<body>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="/view_pdf">View PDF</a></li>
                <li class="menu-item hidden"><a href="/make_pdf">Make PDF</a></li>
            </ul>
        </div>
    </header>

    <!-- Modal -->
    <div id="myModal" class="modal fade my-modal" role="dialog">
        <div class="modal-dialog">

            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-body">
                    <iframe src="/view_pdf" width="100%" height="500px"></iframe>
                </div>
            </div>
    ...
    <section>
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal">Print</button>
        
        <br /><br />

        <iframe src="/view_html" width="100%" height="500px"></iframe>
    </section>
