...
<head>
    ...
    <link rel="resource" type="application/l10n" href="assets/pdfjs/web/locale/locale.properties">
...
<body tabindex="1">
    ...
    <script>
        ...
        document.getElementById('mark').addEventListener('mouseup', (e) => {
            e.preventDefault();
            if (!selected) return;
            if (!range) return;
